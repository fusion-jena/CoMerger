...
<body id="top">
	<form method="post"
		...
		<div class="wrapper bgded overlay"
			...
			<div id="pageintro" class="hoc clear">
				<!-- ################################################################################################ -->
				<article>
					<p class="heading">Multiple Ontologies Merger</p>
					<h2 class="heading">
						<span class="block">Co-Merger</span>
					</h2>
					<footer>
					...
					<div class="table-row">
						...
						<div class="table-cell">
							<article>
								...
								<h6 class="heading">Ontologies Merging</h6>
								<p>Merge your ontologies by a divide-and-conquer
									approach&hellip;</p>
								<footer>
									<a href="#">Read More &raquo;</a>
								</footer>
						...
						<div class="table-cell">
							<article>
								...
								<h6 class="heading">Merge Evaluator</h6>
								<p>Evaluate the merged ontology indepent of the merge
									technique&hellip;</p>
								<footer>
									<a href="#">Read More &raquo;</a>
								</footer>
						...
						<div class="table-cell">
							<article>
								...
								<h6 class="heading">Consistency checker</h6>
								<p>Check the merged ontology consistency by the subjective
									logic theory&hellip;</p>
								<footer>
									<a href="#">Read More &raquo;</a>
								</footer>
							</article>
		...
		<div class="wrapper row3">
			...
			<div class="center btmspace-80">
				<h3 class="heading">Co-Merger - Multiple Ontologies Merging
					Tool</h3>
				<p class="nospace">A tool to merge multiple ontologies by a
					divide-and-conquer method.</p>
			</div>
			<ul class="nospace group cta">
				<li class="one_third first">
					<article>
						<a href="#"><i class="fa fa-line-chart"></i></a>
						<h6 class="heading">Publication</h6>
						<p>See the list of publication, algorithms, and approaches
							used in our prototype&hellip;</p>
						<footer>
							<a
								href="${pageContext.request.contextPath}/aboutUs.jsp#publication">Read
								More &raquo;</a>
						</footer>
					</article>
				</li>
				<li class="one_third">
					<article>
						<a href="#"><i class="fa fa-audio-description"></i></a>
						<h6 class="heading">User guideline</h6>
						<p>See the technical reports and user help&hellip;</p>
						<footer>
							<a href="#">Read More &raquo;</a>
						</footer>
					</article>
				...
				<li class="one_third">
					<article>
						...
						<p>Share your feedback with us&hellip;</p>
						<footer>
							<a href="#">Read More &raquo;</a>
						</footer>
					</article>
	...
	<div class="wrapper bgded overlay"
		...
		<article class="hoc container clear center">
			<!-- ################################################################################################ -->
			<h3 class="heading">Powered by FUSION group</h3>
			<p class="btmspace-50">
				FUnctionality Sharing In Open eNvironments<br>Heinz Nixdorf
				Chair for Distributed Information Systems
			<p>
				<a href="${pageContext.request.contextPath}/aboutUs.jsp">Impressum</a>
			</p>
			</p>
			<footer>
				<a class="btn medium" href="http://fusion.cs.uni-jena.de">More
					Information &raquo;</a>
			</footer>
			<!-- ################################################################################################ -->
		</article>
