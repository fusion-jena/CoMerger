...
<body id="top">
	...
	<div class="wrapper row3">
		...
		how to <a href="${pageContext.request.contextPath}/GMR.jsp">select
			...
			GMR Implementation: <a href="/textdata/EvaluationDetail.pdf" EvaluationDetail.pdf">download the documentation</a>

		<!-- /////////////////////////////////////// --> <!-- ################################################################################################ -->
		<div style="text-align: justify;">
			<h2>GMR: Generic Merge Requirement</h2>
			<p>Ontology merging approaches differ in the set of criteria that
				they aim to fulfill, i.e., what are the requirements they expect the
				merged ontology to meet. A classification and a list of Generic
				Merge Requirement (GMR) extracts from the literature is presented
				here.</p>
			...
			<ul>
				<li><b><font color="#0415AD">Integrity: </font> </b>
					<p>This dimension refers to the degree of knowledge coverage in
						the merge process via (i) completeness aspect, and to the amount
						of knowledge redundancy by (ii) minimality aspect.</p></li>
		...
		<div style="text-align: justify;">
			<ul>
				<h2>Completeness:</h2>
				<p>This aspect refers to knowledge preservation and coverage. It
					includes following GMRs:</p>
				...
				<li><b><font color="#0415AD">R4-</font> Correspondences
					...
					<p>If two entities of the input ontologies are corresponding,
						...
						[6,7,10]. Note that, corresponding can be as equality, similarity or
						is-a correspondences. In each case, the same type of alignment
				...
				<li><b><font color="#0415AD">R9-</font> Property redundancy
						prohibition </b>
				...
				<li><b><font color="#0415AD">R11-</font> Extraneous entity
						prohibition </b>
					<p>No additional entities other than input ontologies' entities
						should be added in the merged result [7].</p></li>
				<hr>
				<h2>Deduction</h2>
				...
				<li><b><font color="#0415AD">R12-</font> Entailments
					...
					<p>The merged ontology should be able to entail all entailments
						of (all/target) input ontologies. As the semantic consequences of
						the integration, it can include more entailments but it should at
						least not miss knowledge from the input ontologies [2]. (for the
						definition of the entail, cf. [2])</p></li>
				<hr>
				<h2>Constraints</h2>
				...
				<li><b><font color="#0415AD">R13-</font> One type
					...
					<p>Two corresponding entities should follow the same data type
						...
						ontology is String and in the other one is Integer, then the range
						of the merged entity ``authorId'' in the merged ontology cannot
						have both types.</p></li>
				...
				<li><b><font color="#0415AD">R15-</font> Property's domain
					...
					<p>The merge process should not result in multiple domains or
						ranges defined for a single property. This rule is recast from the
						ontology modelling issues in [8].</p></li>
				<hr>
				<h2>Acyclicity</h2>
				<p>This aspect refers to the controlling of the chain problem in
					the merged ontology, which includes following GMRs:</p>
				<li><b><font color="#0415AD">R16-</font> Acyclicity in the
						class hierarchy </b>
					<p>A cycle of is-a relationships implies equality of all of the
						classes in the cycle, since is-a is transitive. Therefore, the
						merge process should not produce a cycle in the class hierarchy
						[1,3,5,7,8,10].</p></li>
				<li><b><font color="#0415AD">R17-</font> Acyclicity in the
					...
					<p>The merge process should not produce a cycle between
						properties with respect to the is-subproperty-of relationship [8].</p></li>
				...
				<li><b><font color="#0415AD">R20-</font> Unconnected
					...
					<p>The merge process should not make the properties unconnected
		...
		<div style="text-align: justify;">
			<br> <span><h3>References:</h3>				
				[1] F. Duchateau, and Z. Bellahsene. <i>Measuring
					the quality of an integrated schema.</i> COER 2010.<br> 
				[2] E.Jiménez-Ruiz, et al.<i>Ontology
					integration using mappings: Towards getting the right logical
					consequences.</i> ESWC, 2009. <br>
				[3] S. P. Ju, H. E. Esquivel, et al. <i>Creado-a
					methodology to create domain ontologies using parameter-based
					ontology merging techniques.</i> In MICAI, 2011. <br> 
				[4] M. Mahfoudh, et al. <i>A benchmark for ontologies merging assessment.</i>KSEM 2016. <br> 
				[5] N. F. Noy, et al. <i>Ontology development 101: A guide to creating your first ontology. </i> 2001.<br>
				[6]	N. F. Noy and M. A. Musen. <i>The prompt suite: interactive
					tools for ontology merging and mapping.</i> IJHCS, 59(6):983-1024,
				2003. <br> 
				[7] R. A. Pottinger and P. A. Bernstein. <i>Merging models based
					on given correspondences.</i> In VLDB, pages 862-873, 2003. <br>
				[8] M. Poveda-Villalón, A. Gómez-Pérez, and M. C.Suárez-Figueroa. <i>Oops!(ontology
					pitfall scanner!): An on-line tool for ontology evaluation.</i> IJSWIS,
				2014. <br> 
				[9] S. Raunich and E. Rahm. <i>Towards a benchmark for ontology merging. </i> In OTM, 2012.
				[10] S. Raunich and E. Rahm. <i>Target-driven
