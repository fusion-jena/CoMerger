		...
		<table class="form_settings">
			<tr>
				<td style="width: 100%; text-align: justify;"><hh>Impressum:</hh>
					<br> By using the services of our website ''Co-Merger'', we do
					not keep any personal data from you. Only for the processing of
			...
			<tr>
				<td><hh>Administator:</hh> <br>
				Samira Babalou<br> Leutragraben
					1, Jentower, R17N01<br> 07743 Jena, Germany<br> <br> Phone:
					+49(0)3641-946444 <br> Email: samira.babalou[-at-]uni-jena.de
					<br></td>
			</tr>
