	<div class="wrapper row4">
		<footer id="footer" class="hoc clear">
			<!-- ################################################################################################ -->
			<h3 class="heading">Co-Merger</h3>
			<ul class="nospace inline pushright uppercase">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i class="fa fa-lg fa-home"></i></a></li>
				<li><a href="${pageContext.request.contextPath}/aboutUs.jsp">About Us</a></li>
				<li><a href="${pageContext.request.contextPath}/contact.jsp">Contact Us </a></li>
				<li><a href="${pageContext.request.contextPath}/help.jsp">User Help</a></li>
  ...
  <script>
		grecaptcha.ready(function() {
			grecaptcha.execute('6Lc5rrUUAAAAAKBNdawrac6WLfCWmtTHiqWd4vCH', {
