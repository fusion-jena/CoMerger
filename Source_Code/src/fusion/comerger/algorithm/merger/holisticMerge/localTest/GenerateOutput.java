...
public class GenerateOutput {
	...
	public static void saveQueryResult(String fileName, HashMap<String, String> result, String OmFileName,
			String OmVersion) throws IOException {
		try (
				// PrintWriter writer = new PrintWriter(new File(fileName))) {
				FileWriter writer = new FileWriter(fileName, true)) {
			StringBuilder sb = new StringBuilder();
			...
			// save the name of file
			sb.append(OmFileName);
			sb.append(',');

			sb.append(result.get("compeleteAnswer"));
			sb.append(',');

			sb.append(result.get("semiCompeletAnswer"));
			sb.append(',');

			sb.append(result.get("partialAnswer"));
			sb.append(',');

			sb.append(result.get("wrongAnswer"));
			sb.append(',');

			sb.append(result.get("unknownAnswer"));
			sb.append(',');

			sb.append(result.get("nullAnswer"));
			sb.append(',');

			sb.append(result.get("somthingIsWrong"));
			sb.append(',');
	...
	public static void saveQueryResult_Header(String resultPath) {
		// create csv file
		try (PrintWriter writer = new PrintWriter(new File(resultPath))) {
			...
			sb.append("compeleteAnswer");
			sb.append(',');

			sb.append("semiCompeletAnswer");
			sb.append(',');
			...
			sb.append("nullAnswer");
			sb.append(',');

			sb.append("somthingIsWrong");
			sb.append(',');
	...
	public static void inserEmptyLineQuery(String fileName) throws IOException {
		int currentInfo = 9;
		try (FileWriter writer = new FileWriter(fileName, true)) {
			StringBuilder sb = new StringBuilder();
	...
	public static void saveEvalQueryResult_Header(String fileOutput) {
		try (PrintWriter writer = new PrintWriter(new File(fileOutput))) {
...
//			sb.append(',');
	...
	public static void saveEvalQueryResult(String fileOutput, HashMap<String, String> result, String OmFileName,
			String OmVersion)throws IOException {
		try (
				// PrintWriter writer = new PrintWriter(new File(fileName))) {
			...
			/* ************************* */
			sb.append(result.get("TP"));
			sb.append(',');
			
			sb.append(result.get("FP"));
			sb.append(',');
			
			sb.append(result.get("FN"));
			sb.append(',');
			
			sb.append(result.get("TN"));
			sb.append(',');
			
			sb.append(result.get("precision"));
			sb.append(',');
			
			sb.append(result.get("recall"));
			sb.append(',');
			 
			sb.append(result.get("accuracy"));
			sb.append(',');
			
			sb.append(result.get("label"));
			sb.append(',');
...
//			sb.append(',');
	...
	public static void saveEvalQuery2Result( HashMap<String, String> result, String fileOutput)throws IOException {
		try (
				// PrintWriter writer = new PrintWriter(new File(fileName))) {
				FileWriter writer = new FileWriter(fileOutput, true)) {
			StringBuilder sb = new StringBuilder();

			sb.append(result.get("dataset"));
			sb.append(',');

			sb.append(result.get("QuerySize"));
			sb.append(',');
	...
	public static void saveEvalQuery2Result_Header(  String fileOutput)throws IOException {
		try (
				// PrintWriter writer = new PrintWriter(new File(fileName))) {
				FileWriter writer = new FileWriter(fileOutput, true)) {
			StringBuilder sb = new StringBuilder();
