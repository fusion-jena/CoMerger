		...
		<div class="wrapper row3">
				...
				<li>Scope 2: properties; All properties in the merged ontology
					...
					<ul>
						...
						<li>Scope 2-3: extra properties: this group are some extra
							properties who do not belong to any input ontologies. They
							created trough the merge process.</li>
					</ul>
				</li>
			...
			<ul>
				...
				<li>R5: Scope 2-1, Operation: add; R5 does some changes on the
					...
					the missing properties of the corresponding classes. Indeed, for
					the corresponding classes, if their properties are missing in the
					merged ontology, it should be added.</li>
				...
				<li>R14: Scope 2-1, Operation: rewrite (add + delete); it
					requires to solve the conflict.</li>
				<li>R15: Scope 1-1, Operation: rewrite (add + delete); domain
					or range of properties are the type of classes, so it belongs to
					scope 1-1. It might delete multiple domains or ranges (and only
					keep one of them to satisfy domain and range oneness). In another
					...
					would be: create a new class cc, where cc is the union of c1 and
					c2, and then set cc as the domain of property p.</li>
				...
				<li>R19: Scope 1, Scope 2, Operation: add + delete; It might
					...
					unconnected classes). It might delete the unconnected classes. It
					is also possible on different implementation, R19 uses add
					operation to add unconnected classes to the others.</li>
				<li>R20: Scope 2, Operation: add + delete; It makes some
					changes on the properties. It might delete the unconnected
					properties, or uses add operation to connect them.</li>
			</ul>
