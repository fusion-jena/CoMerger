...
public class AlignmentWriterOwl
{
    private AlignmentOwl alignment = null;
    private RandomAccessFile raf = null;
    private String filepath = null;
    private ArrayList<String> writeList = null;

    public AlignmentWriterOwl(AlignmentOwl as, String fp)
    {
        alignment = as;
        filepath = fp;
        try {
    ...
    public String write(String onto1, String onto2, String uri1, String uri2)
    {
        ...
        for (int i = 0, n = alignment.size(); i < n; i++) {
            MappingOwl map = alignment.getMapping(i);
