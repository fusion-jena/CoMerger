...
public class EvalPanelMatching extends JPanel
{
    ...
    public EvalPanelMatching()
    {
        super();
        setPreferredSize(new Dimension(640, 480));
        setLayout(new BorderLayout());

        final TablePanel alignTable = new TablePanel(correctAlignment);
        ...
        panel_1.add(label_1);
        label_1.setText("Falcon-AO's alignment: ");
        ...
        panel_2.add(label_2);
        label_2.setText("   Reference alignment: ");
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (s1.length() > 0 && s2.length() > 0) {
                    ...
                    AlignmentReader2 reader1 = new AlignmentReader2(
                    		Matching.model1, Matching.model2, s1);
                    AlignmentReader2 reader2 = new AlignmentReader2(
                    		Matching.model1, Matching.model2, s2);
                    ...
                    correctAlignment = result.getCorrectAlignment();
                    errorAlignment = result.getErrorAlignment();
                    lostAlignment = result.getLostAlignment();
                    comboBox.setSelectedIndex(0);
                    alignTable.setAlignment(correctAlignment);
        ...
        comboBox.addItemListener(new ItemListener()
        {
            public void itemStateChanged(ItemEvent e)
            {
                ...
                if (index == 0) {
                    ...
                    alignTable.setAlignment(errorAlignment);
                } else if (index == 2) {
                    alignTable.setAlignment(lostAlignment);
                }
                alignTable.repaintTable();
            }
        });
